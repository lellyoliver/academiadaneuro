...
?>
				...
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'lellyoliver');?>">
				...
				<div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav justify-content-center">
                        ...
                        ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Teste 02</a>
                            </li>
                        <?php endif; ?>

                        <?php 
                        if (in_array('health-pro', $user_roles)) :
                        ?>
                            <li class="nav-item">
                                <a class="nav-link" href="#">Teste 03</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div><!-- /.navbar-collapse -->
